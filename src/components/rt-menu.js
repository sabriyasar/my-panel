...
const menu = (
  ...
  render () {
    ...
    <SubMenu key="sub1" icon={<MailOutlined />} title="Temel bilgileri">
    ...
    <SubMenu key="sub2" icon={<AppstoreOutlined />} title="Araç tarifeleri">
    ...
    <SubMenu key="sub4" icon={<SettingOutlined />} title="Dahil ek hizmetler">
